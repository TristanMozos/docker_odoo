...
class Warehouse(models.Model):
    ...
    def create(self, vals):
        ...
        try:
            ...
            # Because we get lots of tickets for last 5 versions when parent store isn't
            # computed and don't know why. Framework team please look at
    ...
    def _get_transit_locations(self):
        return self.company_id.internal_transit_location_id, self.env.ref('stock.stock_location_inter_wh', raise_if_not_found=False) or self.env[
            'stock.location']
